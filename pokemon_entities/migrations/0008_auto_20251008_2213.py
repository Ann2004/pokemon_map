# Generated by Django 2.2.24 on 2025-10-08 19:13
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('pokemon_entities', '0007_auto_20251008_2127'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            name='appeared_at',
            field=models.DateTimeField(default=datetime.datetime(2025, 10, 8, 19, 13, 23, 125948, tzinfo=utc), verbose_name='время появления на карте'),
        ),
        migrations.AlterField(
            model_name='pokemonentity',
            name='defence',
        ...
        migrations.AlterField(
            model_name='pokemonentity',
            name='disappeared_at',
            field=models.DateTimeField(default=datetime.datetime(2025, 10, 8, 19, 13, 23, 125948, tzinfo=utc), verbose_name='время исчезновения на карте'),
        ),
        migrations.AlterField(
            model_name='pokemonentity',
            name='health',
